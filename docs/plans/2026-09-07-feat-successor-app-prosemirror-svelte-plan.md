...
| 3 — the chrome | IN PROGRESS 2026-09-07. Svelte 5 installed; the notice ledger and the corner, every status line through them; the masthead's first slice (the crumb, the tags, the title row, the tools, the Line numbering row) over shared screen state; both green in headless Helium. Still to come: the books and pages panels and icons, create/rename/delete, Go to, Search, help, the ⌃⌘G bar, the landing mark, "every opener closes the others". | CLAUDE.md "Phase 3 decisions" |
