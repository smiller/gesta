...
| 3 — the chrome | NOT BEGUN. Panels, bars, notices and the masthead as Svelte components; the landing mark; the notices the storage layer already emits through callbacks. | — |
