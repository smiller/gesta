...
| 3 — the chrome | BEGUN 2026-09-07. Svelte 5 installed; the notice ledger and the corner (the indicator and the paused pill) are the first component, every status line routed through them, green in headless Helium. Still to come: panels, bars, the masthead, the landing mark, "every opener closes the others" as one piece of state. | CLAUDE.md "Phase 3 decisions" |
