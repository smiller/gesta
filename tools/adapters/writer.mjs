...
export const read = {
  ...
  /* the grid's readings (2026-09-22): the current app has no grid, so these read what it draws instead — the cards loose, no button, the corner's own words */
