...
const none = () => {};
function draw(date: string, tag: string | null, extra: Partial<{ gutter: boolean; interval: number; panel: "page" | "bookshelf" | "help" | "bookmarks"; rows: { text: string; href: string }[]; empty: string }> = {}): string {
  ...
  return render(Masthead, { props: { screen, onToday: none, onExport: none, onImport: none, onBackups: none, onClear: none, onInterval: none, onPanel: none, onClosePanel: none, onNewRoot: none, onCreate: none, onRename: none, onDelete: none, search: { onToggle: none, onQuery: none, onScope: none, onWalk: none, onEnter: none, onPick: none }, goto: { onToggle: none, onPick: none }, lineBar: { onInput: none, onEnter: none, onClose: none }, bookmarks: { onKey: none, onAct: none, onDraft: none, onCommit: none } } }).body;
}
